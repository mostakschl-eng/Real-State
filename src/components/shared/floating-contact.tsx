...
export function FloatingContact() {
  ...
  const items = [
    ...
    },
    {
      ...
      label: "Call Atelier",
      delay: 0.3,
      icon: <Phone size={28} strokeWidth={1.6} />,
    },
  ];
          ...
          >
            ...
            */}
            ...
            <motion.a
              ...
              className="flex size-20 shrink-0 items-center justify-center rounded-full bg-accent text-canvas shadow-[0_10px_30px_rgba(202,138,4,0.35)]"
